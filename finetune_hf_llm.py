...
def parse_args():
    ...
    parser.add_argument("--train-path", type=str, help="Path to training jsonl file")

    parser.add_argument("--test-path", type=str, help="Path to testing jsonl file")

    parser.add_argument(
        "--special-token-path", type=str, help="Path to token json file"
    )
    parser.add_argument(
        "--no-grad-ckpt",
        action="store_true",
